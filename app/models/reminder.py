...
class Reminder(db.Model):
    ...
    # Core details
    title = db.Column(db.String(50), nullable=True) # Optional title for the reminder (e.g. "Take out trash", "Dinner with family", "Daily Check-In Missed", etc.)
    body = db.Column(db.Text, nullable=False) # Main content of the reminder (e.g. "Don't forget to take out the trash tonight!", "You have a dinner event scheduled for 7pm", "It looks like you missed your daily check-in today. Please remember to complete it when you can!", etc.)
