...
export const UserProfileMainTab = () => {
    ...
    const { data: stats } = useGetUserProfileStatsQuery(Number(userId), {
        skip: !userId,
    });
        ...
        <Tabs.Panel value="profile" className="user-profile-main-container">
            <div className="user-profile-stats">
                <div className="user-profile-stat">
                    ...
                    <span className="user-profile-stat-num">{stats?.checkinStreak} days</span>
                ...
                <div className="user-profile-stat">
                    ...
                    <span className="user-profile-stat-num">{stats?.checkinPct}%</span>
                ...
                <div className="user-profile-stat">
                    ...
                    <span className="user-profile-stat-num">{stats?.tasksCompleted}</span>
