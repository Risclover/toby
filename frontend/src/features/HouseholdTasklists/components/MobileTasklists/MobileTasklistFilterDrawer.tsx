...
import { type TaskFilters } from "@/features/HouseholdTasklists/hooks/useTasklistFiltering";
                ...
                <Stack className="filter-drawer-avatars">
                    ...
                    <Group>
                        {householdMembers?.map((member) => (
                            <Button
                                style={{
                                    border: localFilters.assignedToId === member.id ? "2px solid rgb(5, 5, 73)" : undefined,
                                    cursor: "pointer",
                                }}
                                variant="transparent"
                                radius="xl"
