...
export const PadlockIcon = ({ size, color }: Props) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill={color} height={size} width={size} version="1.1" id="Layer_1" viewBox="0 0 491.52 491.52">
            <g>
                <g>
                    <path
